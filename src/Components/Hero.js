...
const Hero = () => {
  ...
  return (
    <div id='main-hero'>
      <img id='hero-bg' className='parallax hero-bg' data-speedx="0.025" data-speedy="0.0025" src={heroimage} alt="" />
      <img id='hero-layer1' className='parallax layers hero-layer1' data-speedx="0.11" data-speedy="0.11" src={herolayer1} alt="" />
      <img id='hero-layer2' className='parallax layers hero-layer2' data-speedx="0.085" data-speedy="0.085" src={herolayer2} alt="" />
